...
function buildInviteHtml(params: {
  ...
  const { candidateName, inviteCode, expiresAt } = params
...
<head>
  ...
  <title>You're Invited to Olais Eval</title>
</head>
<body style="
  margin: 0;
  padding: 0;
        ...
        ">
          ...
          <tr>
            <td style="padding: 40px 40px 0 40px; text-align: center;">
              ...
              ">You're Invited to Olais Eval</h1>
              <p style="
                margin: 0;
                font-size: 15px;
                line-height: 1.6;
          ...
          <tr>
            <td style="padding: 24px 40px 32px 40px; text-align: center;">
              <p style="
                ...
                color: #94a3b8;
              ">
                Olais Eval &mdash; Skills Assessment Platform
              </p>
              <p style="
                margin: 0;
                font-size: 12px;
...
We are pleased to invite you to participate in the Olais evaluation process. This platform allows you to demonstrate your skills through a series of thoughtfully designed challenges.
...
export async function sendInviteEmail(params: {
  ...
  const { to, candidateName, inviteCode, expiresAt } = params

  const html = buildInviteHtml({ candidateName, inviteCode, expiresAt })
  const text = buildInviteText({ candidateName, inviteCode, expiresAt })

  const subject = candidateName
    ? `You're Invited to Olais Eval, ${candidateName}`
    : "You're Invited to Olais Eval"
